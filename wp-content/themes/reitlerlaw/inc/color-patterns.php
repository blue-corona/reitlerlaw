 ...
 */
function reitlerlaw_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Reitler Law default saturation level.
	 *
	 * @since Reitler Law 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation         = absint( apply_filters( 'reitlerlaw_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.reitlerlaw-front-page) .entry-title,
...
.colors-custom .reitlerlaw-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.reitlerlaw-front-page .panel-content .recent-posts article,
...
.colors-custom.reitlerlaw-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Reitler Law custom colors CSS.
	 *
	 * @since Reitler Law 1.0
	 *
	 ...
	 */
	return apply_filters( 'reitlerlaw_custom_colors_css', $css, $hue, $saturation );
}
